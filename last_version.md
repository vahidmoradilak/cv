...
<head>
    ...
    <meta name="description" content="رزومه حرفه‌ای وحید مرادی - توسعه‌دهنده ارشد فول‌استک">
    <meta name="keywords" content="توسعه‌دهنده  فول‌استک, React, TypeScript, Next.js">
...
body {
    background: var(--bg);
    color: var(--text);
    font-family: 'Vazirmatn', sans-serif, 'tahoma';
    margin: 0;
    padding: 20px;
}
...
.container {
    ...
    border-radius: 10px;
        ...
        .fa-content, .en-content {
            display: none;
        }

        .fa-content.active, .en-content.active {
            display: block;
        }
...
<button class="theme-switch" onclick="toggleTheme()">🌓</button>
        ...
        <div class="fa-content active">
            ...
            <div class="section">
                ...
                <div class="experience-item">
                    ...
                    <ul>
                        <li>تولید اپلیکشین پیام‌رسان بومی برای گروه‌های خاص</li>
            ...
            <div class="section">
                ...
                <div class="section-grid">
                    ...
                    <div class="project-card">
                        ...
                        <p>ایجاد اپلیکشن پیام‌رسان مبتنی بر رمزگذاری پست کوانتوم برای گروه‌های خاص</p>
                        <div class="project-tech">
                            <span>c</span>
                            <span>Python</span>
                            <span>React</span>
                        ...
                        <a href="https://github.com/yourusername/project" target="_blank">مشاهده در گیت‌هاب</a>
                    </div>
                    <div class="project-card">
            ...
            <div class="section">
                ...
                <div class="volunteer-item">
                    ...
                    <div>عضو ویژه</div>
                    <div class="experience-date">1404 - کنون</div>
                </div>
                <div class="volunteer-item">
                    <div class="experience-title">کانون دانش‌آموختگان طرح‌ولایت</div>
                    <div>خادم</div>
                    <div class="experience-date">1400 - کنون</div>
                </div>
            </div>
        ...
        <div class="en-content">
            ...
            <div class="section">
                ...
                <p style="text-align:justify">Master of Science in Computer Engineering, Software Engineering; We have experience in various fields, from full stack and software development to working in the field of security and encryption using modern technologies. After starting our master's degree, we have also entered the field of data analysis. We have experience in the fields of NLP, LLMs, LangChain and GraphChain, Agents and similar issues.</br>
                    We prefer serving in the country to working abroad and we would like to work in a field that is more needed in the country.</br>
                    Overall, despite our ability and strong skills in different fields and experience working with various frameworks, we enjoy learning and gaining new experience.</p>
            </div>
            ...
            <div class="section">
                ...
                <div class="experience-item">
                    ...
                    <ul>
                        ...
                        <li>Production of dedicated filter breakers</li>
            ...
            <div class="section">
                ...
                <div class="achievement-item">
                    ...
                    <div>Measuring organization</div>
            ...
            <div class="section">
                <h2 class="section-title">Membership in Collections</h2>
                <div class="volunteer-item">
    ...
    <p style="text-align:center"><a referrerpolicy='origin' target='_blank' href='https://trustseal.enamad.ir/?id=5253644&Code=hkM6px2BDgc7kTytSjvm93qYhdsgbFt1'><img referrerpolicy='origin' src='https://trustseal.enamad.ir/logo.aspx?id=5253644&Code=hkM6px2BDgc7kTytSjvm93qYhdsgbFt1' alt='' style='cursor:pointer' code='hkM6px2BDgc7kTytSjvm93qYhdsgbFt1'></a></p>
